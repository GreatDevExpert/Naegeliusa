...
<div class="container">
	...
	<div class="row video_with_image">
		<div class="col-md-offset-4 col-md-4 col-sm-offset-4 col-sm-4 col-xs-offset-0 col-xs-12">
			<img src="<?php the_field('header_secondary_image'); ?>" class="img-responsive servicemainimg">
		</div>
	</div>
